...
<svg xmlns="http://www.w3.org/2000/svg" width="467" height="150" viewBox="0 0 467 150" fill="none" role="img" aria-labelledby="descId">
        <title id="titleId">haemoo's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2024 : 2, Total Issues: 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 246.88811801780878;
      }
    }
      ...
      @keyframes fadeInAnimation {
        ...
        <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="#e4e2e2" width="466" fill="#ffffff" stroke-opacity="1"/>

        
      <g data-testid="card-title" transform="translate(25, 35)">
        <g transform="translate(0, 0)">
      <text x="0" y="0" class="header" data-testid="header">haemoo's GitHub Stats</text>
    </g>
      </g>
